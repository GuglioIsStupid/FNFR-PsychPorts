...
return {
	enter = function(self, previous)
        ...
        freeplay.x, options.x, credits.x = -500, -500, -500
        Timer.tween(1, freeplay, {x = -295}, "out-expo")
        Timer.tween(1, options, {x = -320}, "out-expo")
        Timer.tween(1, credits, {x = -345}, "out-expo")
